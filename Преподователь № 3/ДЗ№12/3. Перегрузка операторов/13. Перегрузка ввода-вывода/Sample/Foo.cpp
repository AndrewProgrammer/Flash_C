...
Foo::Foo() : m_character(0), m_data(0)
{
}

Foo::Foo(const int data, const char character) : m_character(character), m_data(data)
{
}

ostream& operator<<(ostream& os, const Foo& obj)
{
    cout << "ostream& operator<<(ostream& os, const Foo& obj)" << endl;
